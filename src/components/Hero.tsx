...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      {/* Top Lighting / Fill for Black Space - Seamless Fade */}
      <div className="absolute top-0 left-0 w-full h-[50vh] bg-gradient-to-b from-primary/10 via-primary/5 to-transparent pointer-events-none z-0" />
      <div className="absolute -top-[10%] -left-[10%] w-[100vw] h-[100vw] bg-secondary/5 rounded-full blur-[150px] animate-pulse pointer-events-none" />
      ...
      <h1
        ref={titleRef}
        className="absolute bottom-[50vh] md:bottom-[14vh] left-0 w-full text-[32vw] md:text-[21vw] font-black whitespace-nowrap text-center select-none pointer-events-none leading-[0.7] tracking-[-0.08em] md:tracking-[-0.08em] z-0"
      >
